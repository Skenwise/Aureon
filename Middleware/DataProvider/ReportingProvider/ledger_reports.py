...
class LedgerReportsProvider:
    ...
    async def get_account_balance(
        ...
        account = await self.account_provider.get_account(account_id)
    ...
    async def get_trial_balance(
        ...
        accounts = await self.account_provider.list_accounts()
        
        account_balances = []
        for account in accounts:
            # Filter by company_id for multi-tenancy
            if hasattr(account, 'company_id') and account.company_id != company_id:
                continue
    ...
    async def get_balance_sheet(
        ...
        for account in accounts:
            ...
            account_type = getattr(account, 'account_type', '').upper()
